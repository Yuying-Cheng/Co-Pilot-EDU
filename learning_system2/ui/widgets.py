...
def add_shadow(widget, blur=18, offset_y=4, color="#0F172A10"):
    """柔和冷色阴影，用于卡片层次。"""
...
def add_shadow_medium(widget, blur=28, offset_y=8, color="#1E293B18"):
    effect = QGraphicsDropShadowEffect()
    effect.setBlurRadius(blur)
    effect.setOffset(0, offset_y)
...
<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  <ellipse cx="100" cy="148" rx="60" ry="8" fill="#91D9C2" opacity="0.28"/>
  <rect x="94" y="95" width="12" height="55" rx="6" fill="#8CBFF4"/>
  <circle cx="100" cy="75" r="38" fill="#2F80ED" opacity="0.9"/>
  <circle cx="72" cy="88" r="22" fill="#65A9F4" opacity="0.85"/>
  <circle cx="128" cy="85" r="26" fill="#65A9F4" opacity="0.8"/>
  <circle cx="100" cy="55" r="28" fill="#20B486" opacity="0.55"/>
  <circle cx="85" cy="65" r="6" fill="#138461"/>
  <circle cx="112" cy="70" r="5" fill="#91D9C2"/>
  <circle cx="96" cy="82" r="4" fill="#FFFFFF" opacity="0.9"/>
  <circle cx="76" cy="82" r="4" fill="#138461" opacity="0.7"/>
...
<svg viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg">
  <rect width="200" height="80" fill="#E8F2FF" rx="8"/>
  ...
  <rect y="80" width="200" height="40" fill="#D5E9FF"/>
  <rect x="70" y="35" width="60" height="55" rx="4" fill="#2F80ED"/>
  <rect x="88" y="22" width="24" height="20" rx="3" fill="#1D5FBF"/>
  <rect x="88" y="63" width="24" height="27" rx="0" fill="#1D5FBF"/>
  <path d="M88 63 Q100 50 112 63" fill="#174B96"/>
  <rect x="76" y="44" width="10" height="12" rx="2" fill="#91D9C2"/>
  <rect x="114" y="44" width="10" height="12" rx="2" fill="#91D9C2"/>
  <rect x="76" y="62" width="10" height="12" rx="2" fill="#91D9C2"/>
  <rect x="114" y="62" width="10" height="12" rx="2" fill="#91D9C2"/>
  <rect x="20" y="55" width="40" height="35" rx="3" fill="#65A9F4"/>
  <rect x="140" y="50" width="42" height="40" rx="3" fill="#65A9F4"/>
  <rect x="50" y="78" width="4" height="12" fill="#8CBFF4"/>
  <circle cx="52" cy="72" r="8" fill="#2F80ED"/>
  <rect x="155" y="75" width="4" height="15" fill="#8CBFF4"/>
  <circle cx="157" cy="68" r="10" fill="#2F80ED"/>
  <path d="M88 90 Q100 95 112 90 L115 120 L85 120 Z" fill="#F59E0B" opacity="0.25"/>
</svg>
"""

ILLUSTRATION_EXPLORE = """
<svg viewBox="0 0 180 130" xmlns="http://www.w3.org/2000/svg">
  <circle cx="90" cy="65" r="55" fill="#E8F2FF" opacity="0.7"/>
  <rect x="45" y="70" width="55" height="38" rx="4" fill="#2F80ED"/>
  <rect x="100" y="70" width="35" height="38" rx="4" fill="#65A9F4"/>
  <rect x="43" y="68" width="4" height="42" rx="2" fill="#1D5FBF"/>
  <line x1="55" y1="82" x2="88" y2="82" stroke="#91D9C2" stroke-width="1.5"/>
  <line x1="55" y1="90" x2="88" y2="90" stroke="#91D9C2" stroke-width="1.5"/>
  <line x1="55" y1="98" x2="75" y2="98" stroke="#91D9C2" stroke-width="1.5"/>
  <circle cx="118" cy="52" r="22" fill="none" stroke="#20B486" stroke-width="4"/>
  <circle cx="118" cy="52" r="15" fill="#FEF3C7" opacity="0.8"/>
  <line x1="134" y1="68" x2="148" y2="83" stroke="#20B486" stroke-width="5" stroke-linecap="round"/>
  <circle cx="110" cy="46" r="4" fill="#138461"/>
  <circle cx="122" cy="54" r="3" fill="#91D9C2"/>
  <circle cx="115" cy="58" r="3" fill="#138461" opacity="0.6"/>
  <circle cx="65" cy="48" r="4" fill="#91D9C2"/>
  <circle cx="82" cy="38" r="3" fill="#138461" opacity="0.7"/>
  <circle cx="50" cy="55" r="3" fill="#2F80ED"/>
</svg>
"""

ILLUSTRATION_CHART = """
<svg viewBox="0 0 160 100" xmlns="http://www.w3.org/2000/svg">
  <rect x="10" y="8" width="140" height="80" rx="8" fill="#E8F2FF"/>
  <line x1="25" y1="20" x2="140" y2="20" stroke="#D5E9FF" stroke-width="1"/>
  <line x1="25" y1="35" x2="140" y2="35" stroke="#D5E9FF" stroke-width="1"/>
  <line x1="25" y1="50" x2="140" y2="50" stroke="#D5E9FF" stroke-width="1"/>
  <line x1="25" y1="65" x2="140" y2="65" stroke="#D5E9FF" stroke-width="1"/>
  <rect x="32" y="38" width="14" height="42" rx="4" fill="#65A9F4"/>
  <rect x="54" y="28" width="14" height="52" rx="4" fill="#2F80ED"/>
  <rect x="76" y="44" width="14" height="36" rx="4" fill="#65A9F4"/>
  <rect x="98" y="22" width="14" height="58" rx="4" fill="#20B486"/>
  <rect x="120" y="32" width="14" height="48" rx="4" fill="#2F80ED"/>
  <polyline points="39,38 61,30 83,44 105,24 127,34"
    fill="none" stroke="#91D9C2" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <circle cx="39" cy="38" r="3.5" fill="#91D9C2"/>
  <circle cx="61" cy="30" r="3.5" fill="#91D9C2"/>
  <circle cx="83" cy="44" r="3.5" fill="#91D9C2"/>
  <circle cx="105" cy="24" r="3.5" fill="#91D9C2"/>
  <circle cx="127" cy="34" r="3.5" fill="#91D9C2"/>
</svg>
"""
...
<svg viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="150" cy="50" r="25" fill="#E8F2FF" opacity="0.7"/>
  <circle cx="150" cy="50" r="15" fill="#2F80ED" opacity="0.15"/>
  <circle cx="60" cy="130" r="8" fill="#FEF3C7" opacity="0.5"/>
  <circle cx="160" cy="120" r="6" fill="#E8F2FF" opacity="0.7"/>
</svg>
"""

ILLUSTRATION_SUCCESS = """
<svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
  <circle cx="60" cy="60" r="50" fill="#E8F2FF" opacity="0.7"/>
  <circle cx="60" cy="60" r="36" fill="#2F80ED"/>
...
class StatCard(QFrame):
    ...
    def __init__(self, label: str, value: str,
        ...
        top = QHBoxLayout()
        lbl = QLabel(label)
        lbl.setStyleSheet(f"color: {TEXT_SEC}; font-size: 12px; font-weight: 700; background: transparent;")
        top.addWidget(lbl)
        top.addStretch()
        if icon_svg:
            try:
        ...
        val = QLabel(value)
        val.setStyleSheet(f"color: {color}; font-size: 28px; font-weight: 900; background: transparent;")
