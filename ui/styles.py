...
BG_DARK    = "#F8F7F5"   # warm ivory background
BG_PANEL   = "#FFFFFF"   # sidebar white
BG_CARD    = "#FFFFFF"   # card white
BG_INPUT   = "#F4F3F0"   # input field
BORDER     = "#E8E5DF"   # hairline border
BORDER_LT  = "#D4CFC6"   # slightly stronger border

ACCENT     = "#1A1A1A"   # near-black primary action
ACCENT2    = "#2E7D52"   # forest green — success only
ACCENT3    = "#B45309"   # warm amber — warning only
ACCENT4    = "#C0392B"   # muted red — danger only
ACCENT5    = "#4A6FA5"   # slate blue — info only

TEXT_PRI   = "#1A1A1A"   # primary text — near-black
TEXT_SEC   = "#6B6560"   # secondary — warm grey
TEXT_DIM   = "#B0AAA2"   # dimmed — stone
...
QPushButton:hover {{ color: {TEXT_PRI}; border-color: {BORDER_LT}; }}
"""
